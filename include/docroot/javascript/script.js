$(function()
{
    ...
    {
        $.get(document.location.href+range+"?format=xml", 
            function(data) {
        ...
        { 
            if (e.keyCode == 13 || e.keyCode == 40)
                    ...
                    moveSelection('RIGHT',e.shiftKey);
                        ...
                        moveSelection('LEFT',e.shiftKey); }).blur(function()  
            {
                var newval = $(this).val();
    ...
    function resetSelection()
    {
        ...
        $(".dragend").removeClass("dragend"); 
        $(".dragtop").removeClass("dragtop");
        $(".dragbottom").removeClass("dragbottom"); 
    ...
    function moveSelection(direction, shift)
    {
