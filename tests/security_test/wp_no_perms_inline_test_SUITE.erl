...
%%%-----------------------------------------------------------------------------
-module(wp_no_perms_inline_test_SUITE).
...
%%------------------------------------------------------------------------------
?test(wp_test1, "/test4/no_perms/a1", "{\"postinline\":{\"formula\":\"bleh\"}}", 401).

?test(wp_test2, "/test4/no_perms/a2", "{\"postinline\":{\"formula\":\"bleh\"}}", 401).

?test(wp_test3, "/test4/no_perms/a1:a1", "{\"postinline\":{\"formula\":\"bleh\"}}", 401).

?test(wp_test4, "/test4/no_perms/a:a", "{\"postinline\":{\"formula\":\"bleh\"}}", 401).

?test(wp_test5, "/test4/no_perms/1:1", "{\"postinline\":{\"formula\":\"bleh\"}}", 401).

?test(wp_test6, "/test4/no_perms/", "{\"postinline\":{\"formula\":\"bleh\"}}", 401).
