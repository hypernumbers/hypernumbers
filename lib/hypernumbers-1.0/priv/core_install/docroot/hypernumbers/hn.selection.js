...
HN.Layout.Selection = function (layout, sheet) {
    ...
    api.mousedown = function (e) {
        ...
        // if the cell is a wiki inline select box don't make it editable
        if (sheet.cell(bounds.y1, bounds.x1).input &&
            sheet.cell(bounds.y1, bounds.x1).input !== "inline" ) {
            return true;
        }
    ...
    api.menuAction_makewikiselect = function () {
    ...
    api.menuAction_defaultwidthcols = function (e) {
        ...
        console.log(HN.Sheet.CELL_WIDTH);
    ...
    api.menuAction_defaultheightrows = function (e) {
        ...
        console.log(api.bounds);
        console.log(sheet.path());
        console.log(HN.Sheet.CELL_HEIGHT);
