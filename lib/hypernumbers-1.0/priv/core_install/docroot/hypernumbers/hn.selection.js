    ...
    public.select = function(key, event)
    {
        ...
        var select_cell = function() {
            ...
            if( tmp.mergeTo ) { 
                ...
                var ntmp = sheet.cell(tmp.mergeTo.y, tmp.mergeTo.x);
                
                if( dir == HN.LEFT ) { 
                    b.x1 = b.x2 = tmp.mergeTo.x - 1; 
                } else if( dir == HN.RIGHT ) {
                    b.x1 = b.x2 = tmp.mergeTo.x + ntmp.merge.right + 1;
                } else if( dir == HN.UP ) { 
                    b.y1 = b.y2 = tmp.mergeTo.y - 1; 
                } else if( dir == HN.DOWN ) {
                    b.y1 = b.y2 = tmp.mergeTo.y + ntmp.merge.down + 1;
                }
            }
        ...
        if( public.is_editing() ) {
            if( public.c.is_formula() &&
                ...
                select_cell = function() {
                    ...
                    var arg = (!public.has_scrolled) 
                        ? dir : public.has_scrolled;
