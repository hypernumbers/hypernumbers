...
HN.Layout.Selection = function (layout, sheet) {
    ...
    api.mouseDownAxis = function (e, xy) {
        ...
        var attr, start, handle, new_val, cell, orig, index, axis, mousemove, mouseup,
        offset, max, b;
        ...
        if (api.is_editing()) {
            ...
            if (api.editor.is_formula() &&
                ...
                selectCell = function () {
                    ...
                    console.log("in hn.selection.js selectCell");
                ...
                selectRange = function () {
                    console.log("in hn.selection.js selectRange");
    ...
    api.mousedown = function (e) {
        ...
        var style, auto, bounds, offy, offx, select, select_start, select_end, auto_scroll,
            stop_auto_scroll, mouseup, mousemove, y, x, href;
    ...
    api.menuAction_createform = function (e) {
        ...
        var x, y, obj, inp,
            ...
            label  = "Question",
            replies = "<a href=\"./replies\">replies</a>",
            path   = sheet.path(),
