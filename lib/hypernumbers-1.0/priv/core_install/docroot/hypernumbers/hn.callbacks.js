...
HN.Callbacks.saveAsTemplate = function (path, name) {
    var args = {"save_template" : {"name": name}};
    HN.Util.postPath(path, args, null);
};
...
HN.Callbacks.set_ghost = function (path, range, value) {
    HN.Util.postRange(path, range, {"set": {"ghost": value}});
};
...
HN.Callbacks.inline_increment = function (path, cell, value) {
...
HN.Callbacks.setMark = function (mark) {
    HN.Util.postPath("", {"mark": mark}, null);
};
...
HN.Callbacks.setChampion = function (path, view, cb) {
    HN.Util.postPath(path, {"default_view": {"view": view}}, cb);
};
...
HN.Callbacks.inviteUser = function (path, email, view, msg) {
