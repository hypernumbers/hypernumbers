HN.Sheet = function(path, data)
{
    ...
    public.cellWidth = function(cell, x) { 
        return cell.mergeWidth  || public.col_width(x);
    };
    public.cellHeight = function(cell, y) { 
        return cell.mergeHeight || public.row_height(y);         
    };
    ...
    function processMergedCell(y, x, cell) { 
        ...
        if( !(cell.merge.down > 0 && cell.merge.right > 0) ) { 
            return;
        }
