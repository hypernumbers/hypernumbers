...
HN.Sheet = function (path, data, canResizeHeight) {
    ...
    api.getInlineDropdown = function (x, y) {
        return dataObj.readDropDown(path, y, x);        
    };
    ...
    api.canWrite = function() {
	      var views = dataObj.readViews(path);
        return (jQuery.inArray("spreadsheet", views) != -1);
    };
    ...
    api.processLoaded = function () {
        ...
        //processMergedCells(); not any longer
