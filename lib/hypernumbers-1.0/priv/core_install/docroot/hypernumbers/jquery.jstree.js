...
(function ($) {
	...
	$(function() {
		var css_string = '#vakata-dragged { display:block; margin:0 0 0 0; padding:4px 4px 4px 24px; position:absolute; top:-2000px; line-height:16px; z-index:10000009; } ';
		$.vakata.css.add_sheet({ str : css_string });
	});
	...
	$(function() {
		var css_string = '' + 
			...
			'#jstree-marker { padding:0; margin:0; line-height:12px; font-size:1px; overflow:hidden; height:12px; width:8px; position:absolute; top:-30px; z-index:10000009; background-repeat:no-repeat; display:none; background-color:silver; } ';
		$.vakata.css.add_sheet({ str : css_string });
...
(function ($) {
	...
	$(function () {
		var css_string = '' + 
			'#vakata-contextmenu { font: 11px sans-serif; display:none; position:absolute; margin:0; padding:0; background:#fff; border:1px solid #999; -border-radius: 4px 4px 0px 0px; -moz-border-shadow: 2p 2p 4px #aaa; -webkit-border-radius : 4px 4px 0px 0px; -webkit-box-shadow: 2px 2px 4px #aaa; z-index:10000009; *width:180px; } ' + 
			'#vakata-contextmenu ul { *width:180px; } ' + 
			'#vakata-contextmenu ul, #vakata-contextmenu li { margin:0; padding:0; list-style-type:none; display:block; } ' + 
			'#vakata-contextmenu li { position:relative; padding:0px; } ' + 
			'#vakata-contextmenu li a { display:block; text-decoration:none; padding: 1px 3px 1px 18px; } ' + 
			'#vakata-contextmenu li a:link, #vakata-contextmenu li a:visited { border-bottom: none; } ' + 
			'#vakata-contextmenu li ins { float:left; width:16px; height:16px; text-decoration:none; margin-right:2px; } ' + 
			'#vakata-contextmenu li a:hover, #vakata-contextmenu li.vakata-hover > a { background : -moz-linear-gradient(center top, #EEE, #BBB) repleat scroll 0 0 transparent; background -webkit-linear-gradient(linear, 0, 40%, 0 70% from(#EEE), to(#BBB)} ' + 
