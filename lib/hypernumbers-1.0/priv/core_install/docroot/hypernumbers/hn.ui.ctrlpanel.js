...
HN.UI.CtrlPanel = function () {
    ...
    makePath, newPage, uploadStart, uploadComplete, buildMapHeader, 
    ...
    loadMap, saveMap, initEvents, showAdvanced, showDeveloper;
    ...
    showAdvanced = function() {
        console.log("showAdvanced fired");
    ...
    uploadStart = function (file, extension) { 
