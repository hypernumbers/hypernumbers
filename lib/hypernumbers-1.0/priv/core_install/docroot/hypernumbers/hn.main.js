...
var hn      = new HN.Site(),
    ...
    showAdvanced, showHidden, show, options;

document.heightCalced = 0;

showAdvanced = function () {
    show("showadvanced", ".hn_advanced");
};

showHidden = function () {
    show("showhidden", ".hn_hidden");
};

show = function (cookiename, selector) {
...
options = {
    ...
    "authError": function (path) {
        window.location.hash = 
            hn.hashUrl.setParam("path", document.location.pathname.toLowerCase());
