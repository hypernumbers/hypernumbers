...
HN.Layout = function (data) {
    ...
    api.gridSizePix  = function () {
        return gridSizePix;
    };
    api.currentSheet = function () {
        return currentTab.sheet;
    };
    api.tabUI        = function () {
    ...
    api.switchTab = function (sheet) {
        ...
        if (!tab) {
            ...
            // first cancel any editor on the current tab
            currentTab.selection.editor.quitEdit();
            // then switch tabs
            currentTab = tab;
        }
        ...
        currentTab.selection.panes.moveTo(sheet.offset.y, 
                                          sheet.offset.x);
        currentTab.selection.panes.refresh();
