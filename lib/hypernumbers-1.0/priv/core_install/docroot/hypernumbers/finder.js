...
// BUG When nodes are added, and displayed in the tree, but the
// nodePaths are not updated.  This issue is fixed my making the
// variables global, which suggests that multiple instances of finder
// are being created when a node is added.
...
*/        
    ...
    public.openPageByPath  = function(pathStr) {
    ...
    public.openPageById = function(id) {
        var pathStr = nodePaths[id];
	public.openPageByPath(pathStr);
    };
