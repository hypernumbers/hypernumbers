...
*/        
	...
	// BUG when selecting a page on a node, something is
	// triggering the selection for the root note, so after
	// loading the selected node, the root node is then loaded.
