...
HN.GridRender = function () {
    ...
    getCurrentRichEditor, setCurrentRichEditor,
    ...
    getCurrentRichEditor = function () {
        return currentRichEditor;
    };

    setCurrentRichEditor = function(cell) {
        currentRichEditor = cell;
    };

    openRichEditor = function () {
        console.log("open the rich editor for " + currentRichEditor);
        console.log($("[data-ref=" + currentRichEditor +"]"));
        var config = {
	          controls : {
	          ...
	          initialContent : "<div>Hey!</div>",
            formWidth      : 200
        };

        $("[data-ref=" + currentRichEditor +"]").wysiwyg(config);
    };

    closeRichEditor = function () {
        console.log("close the rich editor on " + currentRichEditor);
        var content = $("[data-ref=" + currentRichEditor +"]").wysiwyg("getContent");
        console.log(content);
        $("[data-ref=" + currentRichEditor +"]").wysiwyg("destroy");
        currentRichEditor = "";
    };
    ...
    api.bindInline = function (sheet) {
        ...
        inlinerichfn = function (e) {
            setCurrentRichEditor($(e.currentTarget).attr("data-Ref"));
            openRichEditor();
        };

        $(".inlinerich").click(inlinerichfn);

        var inlinerichlosefocusfn = function(e) {
            closeRichEditor();
        };

        $(".inlinerich").blur(inlinerichlosefocusfn);
