...
HN.GridRender = function () {
    ...
    api.bindInline = function(sheet) {
        $("#clinput").focusout(function (e) {
                                   var e = $(e.originalTarget),
                                   path  = document.location.pathname,
                                   ref   = e.attr("data-ref"),
                                   cell  = HN.Util.parse_ref(ref),
                                   val   = e.text(),
                                   s     = ".inline[data-ref="+ref+"]";
                                   $(s).text(val);
                                   HN.Callbacks.set_cell(path, cell, val);
                               });
...
HN.RenderPage = (function () {
    ...
    // fugly, fugly, fugly
    // basically the man sheet routines use a global HN.data to co-ordinate
