...
HN.TableRender = function () {
	...
	var line_view = function(row) {
		...
		// BUG when user holds mouse button down, multiple
		// rows are added quickly. This might be to the OS
		// sending multiple click events when mouse button is
		// held down.
