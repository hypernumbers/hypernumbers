...
HN.TableRender = function () {
	...
	var line_view = function(row) {
		...
		HN.Dialog.open_dialog("lineview");
        ...
        $('#tablecol').columnManager({listTargetID: 'targetcol', onClass:
                                      'simpleon', offClass: 'simpleoff'});
	      var hdrs = { headers: { } };
        ...
        options = {
            ...
            "dataLoaded"   : function () {
                ...
                if (!HN.Util.isInWordpress()) {
                  ...
                  // set the body to overflow so it works with wordpress
...
$("#showhidecols").click(function () {
    HN.Dialog.open_dialog("columnmanagerdialog");
});
