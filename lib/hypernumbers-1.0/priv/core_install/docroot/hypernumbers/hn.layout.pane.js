            ...
            for (x = 0; x < cols; x = x + 1) {
                ...
                if ((!cell || tcol < 0 || trow < 0) && !cell.invisible) {
                   ...
                   if (input === "inline") {
                       ...
                       internaldiv = HN.Util.getPreview(cell);
                   } else if (input == "inlinecheckbox") {
                       if (ghost) {
                           klass = "hn_ghost_checkbox";
                       } else {
                           klass = "inlinecheck";
                       }
                       internaldiv = HN.Util.getPreview(cell);
                   } else if (typeof(input) === "object") {
                       if (Object.keys(input)[0] === "select") {
                           if (ghost) {
                       ...
                       } else if (Object.keys(input)[0] === "increment") {
                           if (ghost) {
                               klass = "inlineincrement hn_ghost";
                           } else {
                               klass = "inlineincrement";
                           }
                           ref = HN.Util.coord_to_ref({"x": x + 1, "y": y + 1});
                           internaldiv = HN.Util.getPreview(cell);
                       };
