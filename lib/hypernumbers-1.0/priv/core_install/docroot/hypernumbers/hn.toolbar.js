...
*/
    ...
    api.createArgument = function(a,f) {
        ...
        n  = nc.join("");
	      ...
	      var l = $( document.createElement('label') ).text(a.name).
            attr("title", a.desc).attr("for", n).attr("id", "l" + n);
        ...
        es = [ e ];
	      ...
	      switch (a.type) {
 	        ...
 	        case "infinite":
	          ...
	          var more = $( document.createElement('span') ).attr("id", "m" + n).
                attr("class", "wizrep").attr("title", "more").text("...")
		            .click( function(a,f,d,z) {
			              return function(ev) {
			                  ...
			                  more.unbind("click").empty().attr("title", "delete").
                            text("X").click( function(a,f,d,z) {
					                      return function(ev) {
						                        d.remove();
    ...
    api.createResizer = function(name,f,def) {
        ...
        z.bind("change", function(ev) {
	      ...
	      var zd = $( document.createElement('span') ).attr("title", "decrease").
            text(" -").click(function (ev) { z.trigger("Decrease"); });
        
	      var zi = $( document.createElement('span') ).attr("title", "increase").
            text(" +").click(function (ev) { z.trigger("Increase"); });
        
	      var e = $( document.createElement('div') ).append(l).append(z).append(zd).
            append(zi);
