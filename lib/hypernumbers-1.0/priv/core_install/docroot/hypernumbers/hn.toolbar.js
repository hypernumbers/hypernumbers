...
HN.ToolBar = function (layout) {
    ...
    api.loadPages = function() {
        var opts = {
            ...
            "activate"     : function () { },
            "deactivate"   : function () { },
            "itemSelected" : function () { hn.ctrlPanel.pageSelected(this.asList());},
            "itemChosen"   : function () {
    ...
    api.loadViews = function() {
        ...
        table = HN.Util.makePermsTable(perms),
       ...
       if (perms.champion) {
        ...
        //
        if (hn.is_admin) {
            var advperms = HN.Util.makeAdvPerms(perms),
        ...
        $("#addgroup").bind("click", function(data) {
            ...
            hide = function (e) {
                if (HN.Util.is_inside(e.target, $("#addgroupmenu")[0])) {
                    ...
                    newperms = hn.data.readPermissions(path);
                    HN.Callbacks.setView(path, view, everyone, newperms.views[view].groups, null);
                };
