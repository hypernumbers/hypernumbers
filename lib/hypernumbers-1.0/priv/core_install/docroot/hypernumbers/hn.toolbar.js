...
*/
	...
	$.get("/hypernumbers/fns_en-GB.json", function(data) {
	   ...
	   $("#wizfunlist").bind("click", function(e) {
		 ...
		 var l = $( document.createElement('label') ).html(f.args[i].name).attr("title", f.args[i].desc).attr("for", "wizarg" + i);
		 var z = $( document.createElement('input') ).attr("id", "wizarg" + i);
		 var e = $( document.createElement('div') ).append(l).append(z);
                 $("#wizfunargs").append(e);
	     }

	     $("#wizfunargscnt").html(f.args.length);
