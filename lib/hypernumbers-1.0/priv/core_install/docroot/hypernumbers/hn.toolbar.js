...
HN.ToolBar = function (layout) {
    ...
    api.loadViews = function () {
        ...
        console.log(HN.Util.makeGroupMenu());
    ...
    api.getFunctionText = function(f, req) {
        ...
        for(var i=0; i<f.args.length; i++) {
	          if (f.args[i].type == "variable") {
	              // push the actual number of arguents
    ...
    function initViews() {
        ...
        $("#addgroup").bind("click", function (data) {
            ...
            // work out the menu widty
            var inside = $("#addgroupmenu").html();
            console.log(inside);
            var hidden = $("#hidden_input").html(inside);
