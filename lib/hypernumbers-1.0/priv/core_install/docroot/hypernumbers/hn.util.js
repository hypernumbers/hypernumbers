...
HN.Util.previewMedia = function(val) {
    ...
    //         +"?center=Brooklyn+Bridge,New+York,NY&zoom=14&size=512x512"
    //         +"&maptype=roadmap&markers=color:blue|label:S|40.702147,"
    //         +"-74.015794&markers=color:green|label:G|40.711614,-74.012318"
    //         +"&markers=color:red|color:red|label:C|40.718217,-73.998284&se"
    //         +"nsor=false' />";
    // }
    return val;
};