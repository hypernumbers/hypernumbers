/*jslint browser: true, undef: true, eqeqeq: true, nomen: true, white: false, maxerr: 100000 */
...
HN.Util.makePermsTable = function(permissions, path) {
    ...
    html += "<span id='hn_previewlink'>Preview: </span><a href='./?view=webpreview'>Web"+
        "</a> <a href='./?view=wikipreview'>Wiki</a>";
    return html;
};
...
{
    for(var i = cell.length, pow = 0, sum = 0; i > 0; i = i - 1) {
        pow = pow + 1;
...
HN.Util.getGroupsAndViews = function(permissions) {
    var data = {},
        ...
        views  = [],
        v;
    for (v = 0; v < permissions.views.length; v = v + 1) {
