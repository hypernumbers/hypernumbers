...
HN.Builder.prototype.setup_events = function()
{
  ...
  HN.Util.addEvent(this.dom.preview, "click", function(e) {

    var id = HN.Builder.find_parent_has_id(e.target);
    var targ = $(that.model).find("[data-hnid="+id+"]")[0];

    that.select_tab("configure");
    HN.Builder.Widgets.configure(targ);
  });
};
...
HN.Builder.find_parent_has_id = function(obj)
{
  ...
  return HN.Builder.find_parent_has_id(obj.parentNode);
};
