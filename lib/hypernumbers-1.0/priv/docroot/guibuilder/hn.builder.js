    ...
    HN.Util.addEvent(HN.Util.id("add"), "mousedown", function(e) {
        if( e.target.nodeName == "INPUT") {
            that.start_drag(e.target, "clone", function(drop) {
                ...
                el.setAttribute("data-hnid", ""+(that.globid++));
        ...
        if( obj ) {
            ...
            that.start_drag(e.target, "remove", function(drop) { 
                ...
                if( drop.action == "click" ) {
                    ...
                    if( that.configuring !== null ) {
                        that.configuring.removeClass("configuring");
                    }
                    ...
                    HN.Builder.Widgets[targ.getAttribute("data-type")]
                        .configure(targ);
...
HN.Builder.Widgets.text = {
    ...
    "configure": function(self) {
        ...
        $("#configure").empty().append(type).append(del);
    },
