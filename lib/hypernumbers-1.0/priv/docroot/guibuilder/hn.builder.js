HN.Builder = function()
{
    ...
    for ( var i in HN.Builder.Widgets ) {
        $("#add").append( HN.Builder.Widgets[i].add ).append("<br />");
    } 
...
HN.Builder.prototype.load_views = function()
{
    ...
    $.getJSON("/?views", function(data) {
        ...
        //that.load_html($("#views li").eq(0).attr("name"));
    });
};
...
HN.Builder.prototype.configure_element = function(obj)
{
    ...
    this.configuring = 
        $("#preview").find("[data-hnid="+id+"]").addClass("configuring");
...
HN.Builder.render_model = function(obj, rendertype)
{
    if( HN.Builder.is_hn_obj(obj) ) {
        ...
        // var hnel = HN.Builder.Widgets[type].render(obj);
        // $(conf).append($("#controlholder").contents().clone()).addClass("wrp");
        // conf.appendChild(hnel);
        // return conf;
...
HN.Builder.Widgets.form = {
    ...
    "add" : "<input type='button' value='form' "
        +"class='btn' data-obj='form' />",
...
HN.Builder.Widgets.input = {
    ...
    "add" : "<input type='button' value='input' "
        +"class='btn' data-obj='input' />",
