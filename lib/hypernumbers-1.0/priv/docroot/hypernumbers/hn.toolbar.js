...
HN.ToolBar = function(layout)
{
  ...
  HN.Util.addEvent(HN.Util.id("rtebtn"), "mousedown", function(e) {
    HN.Util.trail("looking at rich text editor");
  ...
  HN.Util.addEvent(HN.Util.id("rte_submit"), "click", function(e) {
    ...
    HN.Callbacks.set_cell(that.layout.selection.cell, val);
  ...
  HN.Util.addEvent(HN.Util.id("borders"), "mousedown", function(e) {
    if( e.target.nodeName== "A"
      ...
      HN.Callbacks.setBorders(sel.bounds, where, border,
...
HN.ToolBar.prototype.setup_intro = function()
{
  ...
  $("#intronext").click( function() {
    var id = ( t.intro_current == t.intro_pages )
      ? 1 : t.intro_current+1;
    t.show_intro_page(id);
  });

  $("#introback").click( function() {
    var id = ( t.intro_current == 1 )
      ? t.intro_pages : t.intro_current-1;
    t.show_intro_page(id);
  });
...
HN.ToolBar.prototype.show_intro_page = function(x)
{
  ...
  HN.Util.id("intropager").innerHTML = "Page "+this.intro_current
    +" of "+this.intro_pages+" Pages";
...
HN.ToolBar.prototype.addPages = function(data)
{
  var that = this;
