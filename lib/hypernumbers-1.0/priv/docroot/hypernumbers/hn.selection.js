...
HN.Layout.Cell.prototype.calculateWidth = function()
{
    ...
    if( this.input.style.whiteSpace == "normal" ) {
        var xy = Y,
        t      = (sheet.col_width(this.selection.cell.x)-2) +"px";
...
HN.Layout.Cell.prototype.end_edit = function(val)
{
    ...
    if( this.selection.is_light_edit() ) {
        ...
        HN.Callbacks.set_cell(this.layout.s.data.path, 
...
HN.Layout.Selection.prototype.mouseDownAxis = function(e, xy)
{
    ...
    if( e.target.className == "handle" && e.button != 2 ) {
        ...
        var mouseup = function( e ) {
            ...
            if( xy == Y ) {
                HN.Callbacks.setHeight(that.layout.s.data.path, 
                                       index, new_val+4);
            } else {
                HN.Callbacks.setWidth(that.layout.s.data.path,
                                      index, new_val+4);
            }
        };
        ...
        start    = that.getNewOffset(e[attr] - offset, xy);
...
{
    return $.inArray("write", this.layout.s.data.permissions) != -1;
};
...
HN.Layout.Selection.prototype.do_keydown = function(e)
{
                ...
                || e.keyCode == HN.Keys.BACKSPACE))
    {
        ...
        HN.Callbacks.clear(this.layout.s.data.path, this.bounds, "contents");
    }
        ...
        else if ( HN.Util.is_char(e.keyCode) && this.canEdit() ) {
...
{
    this.state = HN.States.SELECTED_RANGE;
    HN.Callbacks.pasteRange(this.layout.s.data.path, this.bounds, 
...
HN.Layout.Selection.prototype.pasteText = function(val)
{
    ...
    if(val.match("\t") === null && val.match("\n") === null) {
        ...
        this.state = HN.States.SELECTED_RANGE;
        HN.Callbacks.pasteValues(this.layout.s.data.path, this.bounds,lines);
...
{
    var i = 1, total = 0, s = this.layout.s
...
HN.Layout.Selection.prototype.dragdown = function(e)
{
    ...
    var mouseup = function(e) {
        ...
        HN.Callbacks.drag(that.layout.s.data.path, 
...
{
    HN.Callbacks.deleteRowCol(this.layout.s.data.path, this.bounds, Y);
};

HN.Layout.Selection.prototype.menuAction_insertrowsafter = function(e)
{
    HN.Callbacks.insertRowCol(this.layout.s.data.path, this.bounds, Y, "after");
};

HN.Layout.Selection.prototype.menuAction_insertrowsbefore = function(e)
{
    HN.Callbacks.insertRowCol(this.layout.s.data.path, 
                              this.bounds, Y, "before");
};

HN.Layout.Selection.prototype.menuAction_deletecols = function(e)
{
    HN.Callbacks.deleteRowCol(this.layout.s.data.path, this.bounds, X);
};
...
HN.Layout.Selection.prototype.menuAction_pastelink = function(e)
{
    ...
    HN.Callbacks.pasteValues(this.layout.s.data.path, this.bounds, arr);
...
{
    HN.Callbacks.clear(this.layout.s.data.path, this.bounds, "all");
};

HN.Layout.Selection.prototype.menuAction_clearformat = function(e)
{
    HN.Callbacks.clear(this.layout.s.data.path, this.bounds, "style");
};
