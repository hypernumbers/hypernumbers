HN.Data = function(options)
{
    ...
    // 
    public.loadPagesMenu = function(path) {
        $.ajax({
            url: path+"?pages", dataType: "json",
            success:   function(data) {
                pagesmenu = data;
                HN.Util.dispatch(options.pagesLoaded, [data]);
            }
        });
    };
    ...
    function updater(time) 
    {
        ...
        update = $.getJSON("/?updates="+time+"&path="+pathstr, fun);  
    };
