...
HN.Callbacks.setBorders = function(range, where, border, border_style, border_color)
{
  HN.Util.postRange(range, {borders: {where: where, border: border, border_style: border_style, border_color: border_color}});
};
...
HN.ToolBar = function(layout)
{
  ...
  add_events("strike","text-decorations",
