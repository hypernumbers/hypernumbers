...
(function($) {
  ...
  $.fn.spreadsheet = function(options)
  {
    ...
    $.fn.toolbar = [
      {css:"left", name:"Left Align", click:function(e,s){ s.range.each(
        function() { set_css(this,"text-align","left"); }); }},
      {css:"center", name:"Center align",  click:function(e,s){ s.range.each(
        function() { set_css(this,"text-align","center"); }); }},
      {css:"right", name:"Right align", click:function(e,s){ s.range.each(
        function() { set_css(this,"text-align","right"); }); }},
      {css:"justify",name:"Justify",click:function(e,s){ s.range.each(
        function() { set_css(this,"text-align","justify"); }); }},
      {css:"separator"},
      {css:"bold", name:"Bold",click:function(e,s){ s.range.each(
        function() { toggle_css(this,"font-weight","normal","bold"); }); }},
      {css:"italic", name:"Italic", click:function(e,s){ s.range.each(
        function() { toggle_css(this,"font-style","normal","italic"); }); }},
      {css:"underl", name:"Underline", click:function(e,s){ s.range.each(
        function() { toggle_css(this,"text-decoration","none","underline"); }); }},
      {css:"strike",name:"Strikethough", click:function(e,s){ s.range.each(
        function() { toggle_css(this,"text-decoration","none","line-through"); }); }},
      {css:"separator"},
      {css:"format", name:"Format Cells", click:function(e,s){
         var f = $("#formats");
         f.toggle();
         select_frame(f,(f.find(".section_list li:first a").text()).toLowerCase());
      }},
      {css:"separator"},
      {css:"form", name:"Edit/Create Form",  click:function(e,s){
         $("#builder").toggle();
       }},
       {css:"formview", name:"View Form", click:function(e,s){
    ...
    var write_button_menu = function(root,$sel,toolbar)
    {
        ...
        $(toolbar).each(function(i)
        {
            ...
            if(typeof this.name != "undefined")
              item.attr("alt",this.name).attr("title",this.name);
