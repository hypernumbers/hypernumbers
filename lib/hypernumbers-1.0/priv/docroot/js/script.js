...
var css_attrs = ["font-style", "font-weight", "font-family", "font-size","text-align", "text-decoration", "text-shadow", "font-stretch", "color", "background-color", "vertical-align", "text-align", "border-color", "border-top", "border-bottom", "border-left", "border-right", "border-bottom-style", "border-top-style", "border-left-style", "border-right-style"];
...
var init = function()
{
  ...
  var savefun = function()
  {
	...
	$.post(document.location.pathname,poststr,postfun,"xml");
  };
...
var create_spreadsheet = function(user)
{
    ...
    var defaults = {
		...
		+ $.fn.to_b26(x+1)+y+"?attr";
            ...
            {
                $.post(fullurl,
                       "<delete><formula/><rawvalue/><value/><__ast/><dependancy-tree/><parents/><__recompile/><__shared/><__area/></delete>",null,"xml");
            }
            else
            {
                $.post(fullurl,
...
load_data = function()
{
        ...
        var add = function(root,dir,path)
	{
		...
		npath = (npath == "/") ? "" : npath;
		var parent = $("<li><a href=\""+path+npath+"/?gui=index\">/"
