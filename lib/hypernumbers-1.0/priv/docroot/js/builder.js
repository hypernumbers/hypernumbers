...
editform['livetable'] = "<div class=\"row\"><div class=\"row\"><label>"
    + "Data Source</label><input type=\"text\" class=\"source\"></div>";

rendered['button'] = "<button>{value}</button>";
editform['button'] = "<div class=\"row\"><div class=\"row\"><label>"
          ...
          {           
              ...
              var each = function()
              {
                  ...
                  if(type == "text" || type== "header" || type == "button")
                      ...
                      data.push([type,"#form","null",$(this).data("source"),"null"]); 
              };
