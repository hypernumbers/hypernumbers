...
HN.Gui.HTML = function(id, componenttype, bindingpage, bindingref, bindingtype,
                       sourcepage, sourceref, sourcetype, post) {
  var element;
  element = HN.Util.id(id);
  switch (componenttype) {
    case "block":
      return HN.Gui.HTML.make_span(id, sourcepage, sourceref, sourcetype, post);
    ...
    case "inputtext":
      return HN.Gui.HTML.make_input_text_fn(id, sourcepage,
                                            ...
                                            bindingtype, post);
    case "inputtextarea":
      return HN.Gui.HTML.make_input_textarea_fn(id, sourcepage,
                                                sourceref, sourcetype,
                                                bindingpage, bindingref,
                                                bindingtype, post);
    case "radio":
      return HN.Gui.HTML.make_radio_fn(id, sourcepage,
                                           sourceref, sourcetype,
                                           bindingpage, bindingref,
                                           bindingtype, post);
    case "checkbox":
      return HN.Gui.HTML.make_checkbox_fn(id,sourcepage,
                                          sourceref, sourcetype,
                                          bindingpage, bindingref,
                                          bindingtype, post);
    case "select":
      return HN.Gui.HTML.make_select_fn(id,sourcepage,
                                        sourceref, sourcetype,
                                        bindingpage, bindingref, bindingtype, post);
    case "dblclick_block":
      return HN.Gui.HTML.make_dblclick_block(id, sourcepage,
                                             sourceref, sourcetype,
                                             bindingpage, bindingref, bindingtype, post);
    case "table":
      return HN.Gui.HTML.make_table(id, sourcepage,
                                    sourceref, sourcetype,
                                    bindingpage, bindingref, bindingtype, post);

    case "dblclick_table":
      return HN.Gui.HTML.make_dblclick_table(id, sourcepage,
                                             sourceref, sourcetype,
                                              bindingpage, bindingref, bindingtype, post);
...
HN.Gui.HTML.onchangefn = function(page, ref, type) {
  return function(e) {
    if ((type === "row") || (type === "col")) {
      console.log("server can't handle posts yet....");
