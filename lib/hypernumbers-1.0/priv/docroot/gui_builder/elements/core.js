...
HN.Tools.Elements.Core.make_configured_element = function() {
  ...
  elem.value = "";
  console.log("Register.selected is " + Register.selected);
  ...
  console.log($("#" + Register.selected).className);
  HNGui.reregister();
  new_id = $(".reregister_selected")[0].id;
  $("#" + new_id).removeClass("reregister_selected");
  console.log("configured element being made with id of: " + new_id);
  Register.selected = new_id;
  Register.currentelement = new_id;
  console.log("in make configured element current element is " + Register.currentelement);
  $("#" + Register.selected).unbind();
  $("#" + Register.selected).bind("click", HN.Tools.Util.click_on_element(new_id,"elementsconfigbox"));
...
HN.Tools.Elements.Core.configure_box = function() {
  ...
  console.log("in configure box current element is " + Register.currentelement);
