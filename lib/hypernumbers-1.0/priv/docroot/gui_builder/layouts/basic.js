...
HN.Tools.Layouts.Basic = function() {
  ...
  c7 = "<div id=\"basicconfig7\" class=\"standardconfig\">"
    ...
    + "<table>"
    + "<tr><td>Very Thin</td><td><input id=\"basic7thickness\" class=\"input ui-state-default\" type = \"radio\" value=\"verythin\" name=\"linethickness\"></td></tr>"
    + "<tr><td>Thin</td><td><input id=\"basic7thickness\" class=\"input ui-state-default\" type = \"radio\" value=\"thin\" name=\"linethickness\"></td></tr>"
    + "<tr><td>Normal</td><td><input id=\"basic7thickness\" class=\"input ui-state-default\" type = \"radio\" value=\"Normal\" name=\"linethickness\"></td></tr>"
      + "<tr><td>Thick</td><td><input id=\"basic7thickness\" class=\"input ui-state-default\" type = \"radio\" value=\"thick\" name=\"linethickness\"></td></tr>"
      + "<tr><td>Very Thick</td><td><input id=\"basic7thickness\" class=\"input ui-state-default\" type = \"radio\" value=\"verythick\" name=\"linethickness\"></td></tr>"
    + "</table>"
    + "</div>";
...
HN.Tools.Layouts.Basic.configure5 = function()
{
  ...
  fn3 = function(ev, ui) {
    var elem;
    console.log("current layout is " + Register.currentlayout);
    elem = HN.Util.id(Register.currentlayout);
...
HN.Tools.Layouts.Basic.make_line = function() {
  ...
  elem.setAttribute("class", "line layout");
  return elem;
};
