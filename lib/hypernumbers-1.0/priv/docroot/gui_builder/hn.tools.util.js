...
HN.Tools.Util.drop_elements = function(e, ui) {
  ...
  config_id = Register.elements[drag]['configid'];
  $("#"+new_id).bind("click", HN.Tools.Util.click_on_element(new_id, config_id));
  $("#"+new_id).bind("dblclick", HN.Tools.Util.pop_config_tab);
  HN.Tools.Register.selected(new_id);
};
...
HN.Tools.Util.drop_layouts = function(e, ui) {
  ...
  config_id = Register.layouts[drag]['configid'];
  $("#"+new_id).bind("click", HN.Tools.Util.click_on_layout(new_id, config_id));
  $("#"+new_id).bind("dblclick", HN.Tools.Util.pop_config_tab);
  HN.Tools.Register.selected(new_id);
};
...
HN.Tools.Util.click_on_element = function(new_id, config_id) {
  return function(ev) {
    console.log("new_id is " + new_id);
    Register.currentelement = new_id;
    console.log("in click_on_element Register.currentelement is " + Register.currentelement);
...
HN.Tools.Util.click_on_layout = function(new_id) {
  return function(ev) {
    Register.currentelement = new_id;
    HN.Tools.Register.selected(ev.currentTarget.id);
    HN.Tools.Register.show_config(config_id);
