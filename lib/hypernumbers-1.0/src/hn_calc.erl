%% @author Dale Harvey
%% @doc Handles Hypernumbers calculation logic

-module(hn_calc).
-author("dale@arandomurl.com").
...
-export([recalc/1, set_attribute/2, set_cell/2, get_cell_info/4]).
-export([write_cell/5, get_hypernumber/9]).
...
handle_call({set,Ref,Val}, _From, State) ->
