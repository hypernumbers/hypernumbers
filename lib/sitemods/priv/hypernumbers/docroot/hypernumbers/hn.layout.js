...
HN.Layout = function(s /*sheet*/) 
{
    ...
    function windowResize() 
    {
        ...
        grid.style.width = $("body").width() - HN.Util.x_pos(grid) + "px";
        ...
        selection.offset  = {
            "y" : HN.Util.y_pos(inner),
            "x" : HN.Util.x_pos(inner)
        };
    ...
    HN.Util.addEvent(window, "resize", 
                     function() { setTimeout(windowResize,10) });
    windowResize();
