...
HN.Layout = function(sheet) 
{
    ...
    function calcScrollbarPos(xy)
    {
        ...
        var gutterS = size[xy.str] - barS;
        var panePos = -parseInt(inner.style[xy.coord], 10);
        var pos      = parseInt(gutterS * panePos / 
                                public.s[xy.dimension]());
    ...
    {        
        ...
        var barSize    = (size[xy.str] / public.s[xy.dimension]()) 
            * gutterSize;
    ...
    function gutterPressed(event, xy) 
    {
        ...
        function gutterScroll() {
            ...
            var barSize   = parseInt(style[xy.str].style[xy.dimension],10);
