...
//        currentTab.selection.gridPos.left = left;
    ...
    public.switchTab = function(sheet) {
        ...
        // public.setGridPos.top(currentTab.selection.gridPos.top);
        // public.setGridPos.left(currentTab.selection.gridPos.left);
    ...
    {        
        ...
        var barSize    = (gridSizePix[xy.str] / currentTab.sheet[xy.dimension]()) 
            * gutterSize;
