...
HN.Layout.Panes.prototype.refresh = function(args)
{
...
{    
    ...
    this.layout.s.offset.y = p.row;
    this.layout.s.offset.x = p.col;
    var pos  = this.layout.s.cell_offset(p.row, p.col);
...
HN.Layout.Panes.prototype.build_cells = function(o)
{
    ...
    for( var y=0; y<this.rows; y++ ) {
        ...
        for( var x = 0; x < this.cols; x++ ) {
            ...
            this.p[y][x] = 
                new HN.Layout.Pane(this.layout.s, row+o.row, (x*5)+o.col);
