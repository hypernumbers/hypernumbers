...
HN.UI.CtrlPanel = function() {
    ...
    public.pageSelected = function(path) { 
        ...
        var update = function(perms) { 
            var everyone = perms.champion && 
                perms.views[perms.champion].everyone;
            $("#currentdefaultview").val(perms.champion);
            $("#everyoneview").attr("checked", everyone);
        };
    ...
    function setPermissionsEveryone(path, everyone) { 
        ...
        // HN.Callbacks.addView(user, pass, function(data) { 
        //     console.log(data);
        // });             
        // console.log(perms.views[perms.champion]);
    ...
    function initEvents() {
        ...
        $("#pagebar a").bind("mousedown", function() { 
            public.open();
        });
