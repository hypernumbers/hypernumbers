  ...
  <div id='outer'>
    ...
    <div id='inner'>
      ...
      <div id='contentwrapper'>
	    <div class='droppable' id='primarycontent'><div data-binding-from='/about_us/C6' class='hn' data-type='text'></div></div>
	    <div class='droppable' id='secondarycontent'></div>
      </div>
      
	  <div class='droppable' id='footer'><div data-binding-from='/about_us/C8' class='hn' data-type='text'></div></div>
